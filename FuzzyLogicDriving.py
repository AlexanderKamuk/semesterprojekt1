...
while emergency_stop == 0:
    ...
    #print("active")
    # Speed mode change
    if voltagey == 3.3 and (1 < voltagex < 2): # Check if joystick button is pressed
        time.sleep(0.2) # Debounce
        Pin.toggle(speed_mode_vis)
    ...
    elif (3.3 > voltagey > 2) and (1 < voltagex < 2): # Joystick is turned backward and button is not pressed
